...
def arriendo_json():
    ...
    for event in calendar.walk('VEVENT'):
        ...
        print(f"Días de arriendo: {dias_arriendo}")
    ...
    print("--------------------------------------------------")
    # Añadir el total de días arrendados
    
    guardar_json(temp_calendar_dir, arriendos)
    print(f"Dias totales arrendados: {dias_arriendo_totales}")

    print("Esquema: ", arriendos)
